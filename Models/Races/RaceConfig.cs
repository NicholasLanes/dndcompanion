    ...
    internal class RaceConfig : IEntityTypeConfiguration<Race>
    {
        public void Configure(EntityTypeBuilder<Race> entity)
        {
            ...
            entity.HasData( // Seeding Race options
                new Race { Id = 0, Name = "Dragonborn" },
                new Race { Id = 1, Name = "Dwarf" },
                new Race { Id = 2, Name = "Elf" },
                new Race { Id = 3, Name = "Gnome" },
                new Race { Id = 4, Name = "Half-Elf" },
                new Race { Id = 5, Name = "Halfling" },
                new Race { Id = 6, Name = "Half-Orc" },
                new Race { Id = 7, Name = "Human" },
                new Race { Id = 8, Name = "Tiefling" });
        }
    }
}
